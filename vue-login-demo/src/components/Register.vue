  ...
  methods: {
    submitForm() {
      ...
      this.axios.get("/api/hello").then(res => {
        console.log("call hello: " + res.data);
      }). catch(handleRejectedAny => {
        console.log("xx: " + handleRejectedAny);
        console.log("xx: " + handleRejectedAny.data);
      })
    ...
    //  this.$refs[formName].resetFields();
      ...
      console.log("form: " + this.RegisterInfo.username)
    },
    goBack() {
      this.$router.go(-1);
    },
